...
import com.smu.hellokotlin2.LastMatchFragment.LastMatchInteractionListener
import com.smu.hellokotlin2.model.DataDetailLeague
import java.text.SimpleDateFormat

/**
 * [RecyclerView.Adapter] that can display a [DummyItem] and makes a call to the
 * specified [LastMatchInteractionListener].
 * TODO: Replace the implementation with code for your data type.
 */
class LastMatchRecyclerViewAdapter(private val mValues: List<DataDetailLeague>, private val mListener: LastMatchInteractionListener?) : RecyclerView.Adapter<LastMatchRecyclerViewAdapter.ViewHolder>() {
        ...
        holder.mView.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v: View) {
                if (null != mListener) {
                    ...
                    mListener.onLastMatchInteraction(holder.mItem!!)
                }
            }
        })
    }
